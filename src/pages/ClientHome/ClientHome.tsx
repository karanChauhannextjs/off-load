...
import { androidAppLink, getTypeCall, iosAppLink, upcomingSessionsReader } from '@utils/helpers.ts';
          ...
          <div className={styles.topMain}>
            ...
            <div className={styles.offloadsCountWrapper}>
              <span className={styles.countText}>
                ...
                <span className={styles.lightCountText}>from other people</span>
              </span>
            </div>
                      ...
                      <div className={styles.arrowsWrapper}>
                        <div
                          className={cn(styles.iconWrapper2, {
                            [styles.disabled]: scrollState?.[index]?.isAtStart,
                          })}
